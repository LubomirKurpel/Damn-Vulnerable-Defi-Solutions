...
describe('[Challenge] The rewarder', function () {
    ...
    it('Exploit', async function () {
		...
		const AttackerContractFactory = await ethers.getContractFactory('CustomTheRewarder', attacker);
		
		// poolAddress, rewarderPoolAddress, damnValuableTokenAddress, rewardsTokenAddress
		this.attackerContract = await AttackerContractFactory.deploy(this.flashLoanPool.address, this.rewarderPool.address, this.liquidityToken.address, this.rewardToken.address);
