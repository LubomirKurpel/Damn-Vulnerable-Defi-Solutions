...
describe('[Challenge] Side entrance', function () {
    ...
    it('Exploit', async function () {
		...
		// Reentrancy attack
		// We drain the funds until there is nothing left using custom contract
		const AttackerContractFactory = await ethers.getContractFactory('CustomSideEntrance', attacker);
